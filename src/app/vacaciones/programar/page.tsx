...
import { CalendarIcon, Check, ChevronsUpDown, Loader2, Save, Trash2 } from 'lucide-react';
import { useCollection, useFirestore, useMemoFirebase, setDocumentNonBlocking, deleteDocumentNonBlocking } from '@/firebase';
import { collection, doc, serverTimestamp, addDoc, Timestamp } from 'firebase/firestore';
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      toast({
        ...
        description: `Se han programado las vacaciones para ${values.empleado.nombre}.`,
  ...
  return (
    <div className="space-y-8">
      <Card className="max-w-6xl mx-auto">
        <CardHeader>
          <CardTitle>Programar Ausencias</CardTitle>
              ...
              <TableBody>
                {loadingVacaciones ? (
                  ...
                  <TableRow key={v.id}>
                    ...
                    <TableCell><Badge variant="secondary">{v.tipo}</Badge></TableCell>
                    ...
                    <TableCell className="text-right">
                      <Button variant="ghost" size="icon" onClick={() => handleDelete(v.id)}><Trash2 className="h-4 w-4" /></Button>
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
